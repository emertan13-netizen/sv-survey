...
st.set_page_config(
    page_title="Clinical Supervision Research Survey",
    page_icon="📋",
    layout="centered",
...
<style>
    ...
    .success-box p { color: #555; font-size: 1rem; }
    .footer-note {
...
<div class="title-block">
    ...
    <p>AI-Powered Support for DClinPsy Clinical Supervision</p>
...
if st.session_state.submitted:
    ...
    <div class="success-box">
        ...
        <p>Your input will directly shape this research project.<br>
